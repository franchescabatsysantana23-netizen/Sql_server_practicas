...
una subconsulta se puede reemplazar por combinaciones y estas últimas son más eficientes.
Puede haber subconsultas dentro de subconsultas, se admiten hasta 32 niveles de anidación.

Que retornen un conjunto de registros de varios campos en lugar de una tabla o
